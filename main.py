...
def processFile(update,bot,message,file,thread=None,jdb=None):
    ...
    if client:
        ...
        finishInfo = infos.createFinishUploading(file,file_size,max_file_size,file_upload_count,file_upload_count,findex,userdata, update.message.sender.username)
...
def onmessage(update,bot:ObigramClient):
    try:
        ...
        if username == tl_admin_user or user_info:  # validate user
            ...
            reply_markup = inlineKeyboardMarkup(
                r1=[inlineKeyboardButton('⚙CONTACTAR SOPORTE⚙',url='https://t.me/Luis_Daniel_Diaz')]
            )
